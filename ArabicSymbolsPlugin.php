...
class ArabicSymbolsPlugin
{
    ...
    private function __construct()
    {
        ...
        $this->symbols = array(
            new ArabicSymbolsInfo('basmallah', array('basmallah')),
            ...
            new ArabicSymbolsInfo('allah', array('allah')),
            new ArabicSymbolsInfo('tamma', array('tamma')),
            new ArabicSymbolsInfo('quran', array('quran')),
            ...
            new ArabicSymbolsInfo('muqaddimah', array('muqaddimah')),
            new ArabicSymbolsInfo('fihris', array('fihris')),
            new ArabicSymbolsInfo('fasl', array('fasl')),
            new ArabicSymbolsInfo('tamhid', array('tamhid')),
            new ArabicSymbolsInfo('tammat', array('tammat')),
            new ArabicSymbolsInfo('bab', array('bab')),
            new ArabicSymbolsInfo('juz', array('juz')),
            new ArabicSymbolsInfo('tahanina', array('tahanina')),
            ...
            new ArabicSymbolsInfo('7izb', array('7izb')),
            new ArabicSymbolsInfo('rubu3', array('rubu3')),
            new ArabicSymbolsInfo('thumun', array('thumun')),
            new ArabicSymbolsInfo('sabt', array('sabt')),
            new ArabicSymbolsInfo('a7ad', array('a7ad')),
            new ArabicSymbolsInfo('ithnayn', array('ithnayn')),
            new ArabicSymbolsInfo('thulatha', array('thulatha')),
            new ArabicSymbolsInfo('arba3a', array('arba3a')),
            new ArabicSymbolsInfo('khamis', array('khamis')),
            new ArabicSymbolsInfo('jumu3a', array('jumu3a')),
            new ArabicSymbolsInfo('mu7arram', array('mu7arram')),
            new ArabicSymbolsInfo('safar', array('safar')),
            ...
            new ArabicSymbolsInfo('rajab', array('rajab')),
            new ArabicSymbolsInfo('cha3ban', array('cha3ban')),
            new ArabicSymbolsInfo('ramadan', array('ramadan')),
            new ArabicSymbolsInfo('chawal', array('chawal')),
            new ArabicSymbolsInfo('dhulqa3da', array('dhulqa3da')),
            new ArabicSymbolsInfo('dhul7jja', array('dhul7jja')),
